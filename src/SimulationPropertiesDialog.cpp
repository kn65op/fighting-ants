...
placing_food_label("Prawdopodobieństwo pojawienia się jedzenia na początku na danym polu:"),
placing_food_button(Gtk::Adjustment::create(properties.GetPlacing_food(), 0, 1, 0.0001, 0.1, 0.0)),
starting_food_label("Prawdopodobieństwo pojawienia się jedzenia w czasie symulacji:"),
